module SpinPolarizedProjectedCrystalWavefunction
export ΨprojCrystal, update_wavefunction!, gibbs_thermalization!
include("../src/symmetric_polynomials.jl")
using .SymmetricPolynomials
include("../src/jk_projection_utilities.jl")
using .JKProjection
...
mutable struct Ψproj
    ...
    Ucrystal::Vector{ComplexF64}
    Vcrystal::Vector{ComplexF64}
